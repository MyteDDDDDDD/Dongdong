    ...
    <body>
        ...
        try {
            ...
            if(request.getParameter("price")!=null){
                ...
                String sql = "UPDATE book SET b_price="+p+" WHERE bid = "+request.getParameter("bid")+"";
                PreparedStatement pstmt1 = con.prepareStatement(sql);
                pstmt1.executeUpdate(); 
            }
            else if(request.getParameter("quality")!=null){
                int i=Integer.parseInt(request.getParameter("quality"));
                String sql = "UPDATE book SET b_stock="+i+" WHERE bid = "+request.getParameter("bid")+"";
                PreparedStatement pstmt1 = con.prepareStatement(sql);
                pstmt1.executeUpdate();
            }
